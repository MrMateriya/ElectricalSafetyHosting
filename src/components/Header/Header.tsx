    ...
    return (
        <header className={[styles['header'] || className].join(' ')} {...props}>
            <nav className={[styles['header__wrapper'] || classNameWrapper, 'container'].join(' ')}>
                ...
                <svg className={styles['burger-button__svg']} width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M3.9502 7.94995H35.9502M3.9502 19.95H35.9502M3.9502 31.95H35.9502" stroke="var(--black)"
                              strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                </button>
                <div className={[styles['header__menu'], isShowMenu? styles['menu'] : styles['menu_closed']].join(' ')}>
                    <svg onKeyDown={e => {handleTabSelection(e, handleOpenMenu, e)}}
                         tabIndex={0}
                         onClick={handleOpenMenu} className={styles['menu__cross']} width="24" height="24" viewBox="0 0 24 24" fill="none"
